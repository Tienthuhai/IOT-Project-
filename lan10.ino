...
void setup() {
  ...
  timer.setInterval(10000L, sendToGoogle);
...
void sendToGoogle() {
  ...
  String url = String("https://script.google.com/macros/s/AKfycbwjjc-wxXgyxiwA52MP-IFk9bjI6a3LwsCBPYSav1aDwhm0Xv4cXSkkc0SbuVqEzhKw/exec?") +
  ...
  Serial.println("Đã gửi dữ liệu lên Google Sheets");

  // Gửi đồng thời lên Blynk
